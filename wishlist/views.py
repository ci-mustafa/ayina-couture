...
def list_wishlist(request):
    ...
    Returns:
        A rendered template ('wishlist/wishlist.html') with
...
def add_to_wishlist(request, product_id):
    ...
    This view checks if the product is already in the user's wishlist.
    If it is not, the product is added to the wishlist and a
    success message is shown. If the product is already in the wishlist,
    an informational message is displayed.
    Args:
        request: The HTTP request object containing the user 
        information and optional redirect URL.
        product_id: The ID of the product to be added to the wishlist.
    Returns:
        Redirects the user back to the product details page or
        the wishlist page, based on the request data.
    """
...
def remove_wishlist_item(request, product_id):
    ...
    This view checks if the product exists in the user's wishlist.
    If it does, it removes the product and displays a success message.
    If the product is not in the wishlist, an error message is displayed.
    Args:
    ...
    Returns:
        Redirects the user back to the wishlist page after attempting
